...
const recipes = [{
    ...
    title: 'Apple Strudel',
    description: "",
    ingredients: ['baking powder', 'cinnamon', 'eggs', 'apples', 'sugar', 'raisins', 'milk'],
    detailedIngredients: ['1 Granny Smith apple - peeled, cored and coarsely shredded', '3 Granny Smith apples - peeled, cored and sliced', '1 cup brown sugar', '1 cup golden raisins', '1 sheet frozen puff pastry, thawed', '1 egg', '¼ cup milk'],
    ...
    ingredients: ["tomatoes", "red pepper flakes", "onion", "butter"],
    detailedIngredients: ["1 tablespoon unsalted butter or margarine", "1 tablespoon olive oil", "1 onion, thinly sliced", "2 large garlic cloves, peeled and crushed", "2 (28 ounce) cans whole peeled tomatoes", "1 tablespoon sugar", "1 teaspoon salt, plus more to taste", "freshly ground black pepper to taste", "1 pinch red pepper flakes"],
...
},
{
    ...
    ingredients: ["salmon", "green onions"],
    detailedIngredients: ["3 (12 inch) untreated cedar planks", "1/3 cup vegetable oil", "1 1/2 tablespoons rice vinegar", "1 teaspoon sesame oil", "1/3 cup soy sauce", "1/4 cup chopped green onions", "1 tablespoon grated fresh ginger root"],
